...
Write a method called max_by that behaves similarly for Arrays. It should take an Array and a block, and 
...
def max_by(array)
  current_largest_element = nil
  array.each do |element|
    if current_largest_element == nil
      current_largest_element = element
    else
      if yield(element) > yield(current_largest_element)
        current_largest_element = element
      end
    end
  end
  current_largest_element
end
