...
In this article, we have discussed variables, variable scope through using local variables, and how variable scope is related to method definitions and method invocations. For a more advanced discussion of scope and how it relates to bindings, please see my next article called [Binding in Ruby](https://mkalisz.medium.com/binding-in-ruby-9e3c9f26977c). 